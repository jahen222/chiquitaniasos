    ...
    <div class="impl_welcome_wrapper impl_bottompadder80" style="background-color: black;">
        <div class="container">
              ...
              <div class="col-md-6 text-center search-panel">
                  <form class="form-horizontal" role="form" method="POST" action="{{ url('users/'.Auth::user()->id.'/update/personalData') }}">
                      {{ csrf_field() }}
                      {{ method_field('PUT') }}
                      ...
                      <div class="panel panel_without_border panel-default">
                          ...
                          <div class="panel-body">
                              ...
                              <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                  <label for="first_name" class="col-md-4 control-label">Nombre completo</label>
                              ...
                              <div class="form-group{{ $errors->has('street') ? ' has-error' : '' }}">
                                  <label for="street" class="col-md-4 control-label">Dirección</label>
